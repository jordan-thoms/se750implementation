...
public class GreaterThanExpression implements FilterExpression {
	...
	public boolean evaluate(Map<Variable, Object> assignment) {
		if ( arg1 instanceof Variable && arg2 instanceof Variable){
			  ...
			  if (MatchIterator.compareTo(assignment.get(var1),assignment.get(var2)) <= 0) 
			  ...
			  if (!assignment.containsKey(var1))
				  ...
				  if (MatchIterator.compareTo(assignment.get(var1),arg2) <= 0) 
			  ...
			  if (MatchIterator.compareTo(arg1,assignment.get(var2)) <= 0)
