...
public class RDFS {
  ...
  //Properties pdstore
    public static final String comment_pdstore = "comment";
    public static final String label_pdstore =  "label";
    public static final String subClassOf_pdstore  = "subClassOf";
}
