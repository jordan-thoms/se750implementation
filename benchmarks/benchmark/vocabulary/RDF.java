...
public class RDF{
    ...
    //Properties pdstore
    public static final String first_pdstore = "first";
    public static final String rest_pdstore =  "rest";
    public static final String subject_pdstore =  "subject";
    public static final String predicate_pdstore ="predicate";
    public static final String object_pdstore = "object";
    public static final String type_pdstore =  "type";
    public static final String value_pdstore =  "value";
}