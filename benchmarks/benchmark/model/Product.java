...
public class Product extends BSBMResource{
	...
	{
		return getURIref_pdstore(nr, producer);
	}
	
	public static String getURIref_pdstore(int productNr, int producerNr)
	{
		StringBuffer s = new StringBuffer();
		//s.append("<");
		s.append(Producer.getProducerNS_pdstore(producerNr));
		s.append("Product");
		s.append(productNr);
		//s.append(">");
		return s.toString();
