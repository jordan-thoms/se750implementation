...
public class Producer extends BSBMResource {
    ...
    public String toString()
	{
	 ...
	 public String toString_pdstore()
		{
			return getURIref_pdstore(nr);
		}
	 
	 public static String getURIref_pdstore(int producerNr)
		{
	...
	public static String getProducerNS_pdstore(int producerNr)
	{
		StringBuffer s = new StringBuffer();
		s.append(BSBM_pdstore.INST_NS);
