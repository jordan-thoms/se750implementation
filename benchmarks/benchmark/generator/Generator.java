...
public class Generator {
	...
	private static int productCount = 666;//666-250K tuples;100-default;2785-1M;70812-25M;284826-100M
	private static boolean forwardChaining = false;
	private static String outputDirectory = "td_data";
	public static String outputFileName = "PDStorebenchmark_ScaleFactor_"+productCount;//"dataset";
	private static String serializerType = "nt"; 
	private static int nrOfOutputFiles = 1;
	private static boolean requiresPDstoreTripleFormat = true;
	...
	static final String dictionary1File = "benchmarks\\titlewords.txt";//"C:/Learning/Softwares/package/pdstore/benchmarks/titlewords.txt";//
	static final String dictionary2File = "benchmarks\\titlewords.txt";
	static final String dictionary3File = "benchmarks\\givennames.txt";
	...
	public static void createProductTypeHierarchy(Long[] seeds)
	{
		...
		if(nr!=maxProductTypeNrPerLevel.get(maxProductTypeNrPerLevel.size()-1))
			maxProductTypeNrPerLevel.add(nr);
		bundle.commitToSerializer(requiresPDstoreTripleFormat);
