...
public class PDDelete implements PDInstance {
	...
	static {
		DALClassRegister.addDataClass(typeId, PDDelete.class);
	}
	...
	/**
	 * Creates an PDDelete object representing the given instance in the given cache.
	 * @param workingCopy the working copy the instance should be in
	 */
	public PDDelete(PDWorkingCopy workingCopy) {
	 ...
	 */
	public PDDelete(PDWorkingCopy workingCopy, GUID id) {
	 ...
	 */
	public static PDDelete load(PDWorkingCopy pdWorkingCopy, GUID id) {
